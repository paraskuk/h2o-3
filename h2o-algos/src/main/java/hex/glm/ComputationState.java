...
//  private int [] _classOffsets = new int[]{0};
  ...
  protected GramXY computeNewGram(DataInfo activeData, double [] beta, GLMParameters.Solver s){
    ...
    GLMTask.GLMIterationTask gt = new GLMTask.GLMIterationTask(_job._key, activeData, _glmw, beta,_activeClass, s.equals(GLMParameters.Solver.COORDINATE_DESCENT)).doAll(activeData._adaptedFrame);
